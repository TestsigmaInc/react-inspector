              ...
              <span style={styles.floatButtons}>
                {
                  ...
                  floatDropDownButtons && floatDropDownButtons([...attributesMap()], data) : floatButtons && floatButtons(data)
                }
              </span>
            }
        </>
            ...
            <span onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} 
                style={{ ...styles.base, ...(isHovered ? styles.base[':hover'] : {})}} >
                  ...
                  <span style={styles.floatButtonsWrap}>
                    {isHovered ? <TSActionButtons data={data} styles={styles} floatDropDownButtons={floatDropDownButtons} floatButtons={floatButtons}/> : <></> }
                  </span> 
            </span>
        </>
      );
